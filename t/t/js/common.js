$(document).ready(function() {
    ...
    $("#go_to_track_step").click(function(){
    	if ($('#information_content_relize_name').val() !== ''){   		
    		...
    		console.log(data);
    		$('.relize_nav a').first().removeClass('active');
    		$('.relize_nav a').eq(1).addClass('active');
    ...
    $(".track_info_back").click(function(){
    	$('.relize_nav a').first().addClass('active');
    	$('.relize_nav a').eq(1).removeClass('active');
    ...
    $("#track_info_next").click(function(){
    	if ($('#track_name').val() !== '' && $('#chose_role').val() !== ''){   		
    		...
    		console.log(data);
    		$('.relize_nav a').eq(1).removeClass('active');
    		$('.relize_nav a').eq(2).addClass('active');    		
    		$('.track_content').hide();
